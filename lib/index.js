  ...
  if (!options) {
    ...
    babel = {
      ...
      presets: defaultPresets.concat(isNode ? [['env', {
        ...
        useBuiltIns: false,
        debug: false
      }]] : []).concat(presets).filter(function (o) {
        return !!o;
      }),
      plugins: defaultPlugins.concat(isNode || isDebug ? ['transform-react-jsx-source', 'transform-react-jsx-self'] : []).concat(plugins).filter(function (o) {
        return !!o;
      })
    };
  }
